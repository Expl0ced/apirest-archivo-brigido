...
export declare class Folder extends Client {
     ...
     */
    getInfo(folderKey: string, details?: 'no' | 'yes' | 'shallow'): Promise<MF.FolderInfo>;
    /**
     ...
     */
    getDepth(folderKey: string): Promise<MF.FolderDepth>;
    /**
     ...
     */
    getContent(folderKey: string, contentType: 'folders' | 'files', chunk?: number, chunkSize?: number, details?: 'no' | 'yes' | 'shallow', orderDirection?: 'asc' | 'desc', orderBy?: 'name' | 'size' | 'created' | 'downloads', filter?: 'application' | 'archive' | 'audio' | 'development' | 'document' | 'image' | 'presentation' | 'spreadsheet' | 'video'): Promise<MF.FolderContent>;
    /**
     * Updates a folder's information.
     */
    update(): Promise<MF.FolderUpdated>;
    /**
     * Move one or more user's folders to target destination.
     */
    move(folderKeySrc: string, folderKeyDst: string): Promise<MF.FolderMoved>;
    /**
     * Copies a session user's folder and its children to a target destination.
     */
    copy(): Promise<MF.FolderCopied>;
    /**
     ...
     */
    delete(): Promise<MF.FolderDeleted>;
    /**
     ...
     */
    search(folderKey: string, searchText: string, searchAll?: boolean, details?: 'no' | 'yes' | 'shallow', filter?: 'public' | 'private' | 'application' | 'archive' | 'audio' | 'development' | 'document' | 'image' | 'presentation' | 'spreadsheet' | 'video'): Promise<MF.FolderSearch>;
}
